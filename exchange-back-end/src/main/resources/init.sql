...
CREATE SEQUENCE IF NOT EXISTS messages_log_sequence_incoming;

CREATE TABLE IF NOT EXISTS messages_log_incoming (
  id INTEGER DEFAULT NEXTVAL('messages_log_sequence_incoming'),
...
CREATE TABLE IF NOT EXISTS messages_log_outgoing (
  id INTEGER DEFAULT NEXTVAL('messages_log_sequence_outgoing'),
  time TIMESTAMP NOT NULL,
  beginstring CHAR(8) NOT NULL,
  sendercompid VARCHAR(64) NOT NULL,
  sendersubid VARCHAR(64) NOT NULL,
